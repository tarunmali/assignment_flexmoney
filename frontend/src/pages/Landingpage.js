  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100">
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">
        "Indulge in heavenly experience once every month"
      </h2>
      ...
      <div className="grid grid-cols-4 gap-4 mt-4">
        <button onClick={() => handleSlotSelection(1)}>
          <div
            className={`text-center px-4 py-2 ${
              selectedSlot === 1 ? "bg-green-500 text-white" : "text-gray-500"
            }`}
          >
            <p>Slot 1</p>
            <p>6-7AM</p>
        ...
        <button onClick={() => handleSlotSelection(2)}>
          <div
            className={`text-center px-4 py-2 ${
              selectedSlot === 2 ? "bg-green-500 text-white" : "text-gray-500"
            }`}
          >
            <p>Slot 2</p>
            <p>7-8AM</p>
        ...
        <button onClick={() => handleSlotSelection(3)}>
          <div
            className={`text-center px-4 py-2 ${
              selectedSlot === 3 ? "bg-green-500 text-white" : "text-gray-500"
            }`}
          >
            <p>Slot 3</p>
            <p>8-9AM</p>
        ...
        <button onClick={() => handleSlotSelection(4)}>
          <div
            className={`text-center px-4 py-2 ${
              selectedSlot === 4 ? "bg-green-500 text-white" : "text-gray-500"
            }`}
          >
            <p>Slot 4</p>
            <p>5-6PM</p>
      ...
      <p className="text-gray-500 mt-8">4 slots available this month.</p>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="w-2/3 px-4 mt-8">
            ...
            <p className="text-lg mb-4">
              Embark on a journey of discovery and excitement. Uncover new
              places, meet incredible people, and create lasting memories that
