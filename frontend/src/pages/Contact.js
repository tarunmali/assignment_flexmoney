      ...
      <div className="contact_info">
        ...
        <div className="contact_form ml-80">
          <div className="container">
            <div className="row">
              <div
                className="lg:w-4/5 pr-4 pl-4 lg:mx-1/6
  "
              >
                <div className="contact_form_container py-5 shadow-5xl">
                  <div className="contact_form_title shad">Get in Touch </div>
                  <form method="POST" id="contact_form ">
                    ...
                    <div className="contact_form_text mt-5">
                      <textarea
                        className="text_field contact_form_message border"
                        name="message"
                        placeholder="Message"
                        cols="70"
                        rows="10"
                    ...
                    <div className="contact_form_button ">
                      <button
                        type="submit"
                        className="button contact_submit_button bg-green-200 p-2 m-100"
                      >
                        Send Message
                      </button>
                    </div>
